...
class PrompterApp:
    ...
    def blink_tempo(self):
        ...
        self.canvas.create_rectangle(0, 0, width, border_thickness, fill=next_color, outline="")
        self.canvas.create_rectangle(0, height - border_thickness, width, height, fill=next_color, outline="")
        self.canvas.create_rectangle(0, 0, border_thickness, height, fill=next_color, outline="")
        self.canvas.create_rectangle(width - border_thickness, 0, width, height, fill=next_color, outline="")
